...
// On-Prem node component with distinct styling and expandable details
export const OnPremNode = memo(({ data, isConnectable, id }: NodeProps) => {
  ...
  const baseColor = data.color || "#64748b" // Default to slate for on-prem nodes
  ...
  const logs = data.logs || [
    { timestamp: "2025-04-30T14:32:15Z", level: "INFO", message: "On-prem process started" },
    { timestamp: "2025-04-30T14:32:16Z", level: "INFO", message: "Connecting to local database" },
    { timestamp: "2025-04-30T14:32:18Z", level: "INFO", message: "Executing query on local resources" },
    { timestamp: "2025-04-30T14:32:20Z", level: "WARN", message: "High CPU usage detected" },
    { timestamp: "2025-04-30T14:32:22Z", level: "INFO", message: "On-prem process completed" },
  ]
  ...
  const config = data.config || {
    ...
    memory: "8GB",
    timeout: "25s",
    lastModified: "2025-04-28T16:45:12Z",
  }
  ...
  return (
    ...
    >
      {/* Main node container with on-prem-specific styling */}
      <div
        className={`relative overflow-hidden rounded-md transition-all duration-300 ${isExpanded ? "shadow-lg" : ""}`}
        style={{
          background: `linear-gradient(145deg, ${lighterColor}10, ${baseColor}20)`,
          boxShadow:
            isHovered || isExpanded
              ? `0 4px 12px rgba(0, 0, 0, 0.15), 0 0 0 2px ${baseColor}50`
              : `0 2px 8px rgba(0, 0, 0, 0.1), 0 0 0 1px ${baseColor}40`,
      ...
      >
        ...
        <div className="relative z-10 p-4">
          {/* Server icon in top-left corner */}
...
OnPremNode.displayName = "OnPremNode"
